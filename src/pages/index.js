      ...
      <>
        ...
        <header className="header">
          <nav className="header__nav">
            ...
            <div className="header__menu-trigger" onClick={() => this.setState({ menuHidden: !this.state.menuHidden })}>
              <span>Navigation</span>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path d="M24 6h-24v-4h24v4zm0 4h-24v4h24v-4zm0 8h-24v4h24v-4z" />
              </svg>
            </div>
            <ul className={this.state.menuHidden ? 'header__menu header__menu--hidden' : 'header__menu'}>
              <li className="header__menu-item">
                <Link className="header__menu-item-link header__menu-item-link--active" to="/">
                  Home
                </Link>
              </li>
              <li className="header__menu-item">
                <a className="header__menu-item-link" href="#about-me" onClick={() => this.setState({ menuHidden: true })}>
                  About
                </a>
              </li>
              <li className="header__menu-item">
                <a className="header__menu-item-link" href="#resume" onClick={() => this.setState({ menuHidden: true })}>
                  Resume
                </a>
              </li>
              <li className="header__menu-item">
                <a className="header__menu-item-link" href="#work" onClick={() => this.setState({ menuHidden: true })}>
                  Work
                </a>
              </li>
              <li className="header__menu-item">
                <a className="header__menu-item-link" href="#contact" onClick={() => this.setState({ menuHidden: true })}>
                  Contact
                </a>
              </li>
            </ul>
            <ul className="header__links-menu">
              ...
              <li className="header__links-menu-item">
                <a href="https://github.com/mgorzanski" className="header__links-menu-item-link">
                  <svg className="header__links-menu-item-icon" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="#fff">
          ...
          <div className="header__jumbotron">
            <div className="header__jumbotron-inner">
              <h1 className="header__jumbotron-title">Front-end and React/React Native Developer</h1>
              <h4 className="header__jumbotron-subtitle">Programmer | Student | Aspiring Software Developer</h4>
              <span className="header__jumbotron-text">My name is Mateusz. I build websites and apps.</span>
            </div>

            <div className="header__jumbotron-icon">
              <a href="#about-me">
                <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" transform="rotate(90)" fill="#fff" viewBox="0 0 24 24">
            ...
            <div className="section__inner">
              ...
              <div className="section__columns">
                <p className="section__column">
                  My name is Mateusz, I’m a high school student.<br />
                  I’m interested in computers since childhood, and I'm trying to learn new things everyday. Currently most of the
                  time I'm focused on web development. 
                  I love working with React and JavaScript. I’m also proficient in HTML5 and CSS3. 
                  I have basic skills in GIT as well as in other technologies. 
                  You can check a full list of skils in my <span className="text-important"><a href="#contact">resume</a></span>.
                </p>
                <p className="section__column">
                  Besides that I'm a reliable person, I passionate about my job and 
                  currently working towards becoming a software engineer in a future. 
                  I have a lot of interests besides coding and computers such as foreign languages, 
                  psychology, music, self-improvement, fashion, games, photography and of course cars.
                </p>
                <p className="section__column">
                  I love learning new things and to discover exciting technologies.
                  <br /><br />
                  <Img fluid={this.props.data.profilePhoto.childImageSharp.fluid} alt="Profile photo" className="section__column-profile-photo" />
                </p>
              </div>
            </div>
            <When condition={this.state.jobOffers}>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <br />
                      Ability to use package managers such as NPM and Yarn as well as task manager Webpack
                      <br />
                      JavaScript
                      <br />
                  ...
                  <tr>
                    ...
                    <td>
                      <span>Finalist in 7th edition</span> of Polish nationwide computer science competition <span>PING – Potyczki Informatyczne Nowej Generacji</span>
                      <br />
                      organised by West Pomeranian University of Technology in Szczecin
                      <br />
                      <span>4th place, honourable mention</span> in XIV Polish nationwide computer science competition
                      <br />
                      organised by The College of Tourism and Ecology in Sucha Beskidzka
                    </td>
                  </tr>
                  <tr>
                    <th>Education</th>
                    ...
                    <td>
                      <span>High School, Centrum Kształcenia Zawodowego i Ustawicznego nr 2, Wadowice, 2016 - 2020</span>
                      <br />
                      IT technician
                    </td>
                  </tr>
          ...
          <section className="section" id="work">
            <div className="section__inner">
              ...
              <div className="section__columns">
                <div className="section__column">
                  <div className="project-link">
                    <Img fluid={this.props.data.devbees.childImageSharp.fluid} alt="devbees" className="project-image" />
                    ...
                    <div className="project-links">
                      ...
                      <a className="project-link-btn" href="http://sharku.ct8.pl/devbees/" role="button">
                        ...
                        <svg className="project-link-btn-svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                ...
                <div className="section__column">
                  <div className="project-link">
                    <Img fluid={this.props.data.dancehouse.childImageSharp.fluid} alt="Dance House" className="project-image" />
                ...
                <div className="section__column">
                  <div className="project-link">
                    <Img fluid={this.props.data.today.childImageSharp.fluid} alt="Today" className="project-image" />
              ...
              <div className="section__columns">
                <div className="section__column">
                  <div className="project-link">
                    <Img fluid={this.props.data.personalwebsite.childImageSharp.fluid} alt="Personal website" className="project-image" />
                ...
                <div className="section__column">
                  <div className="project-link">
                    <Img fluid={this.props.data.calendar.childImageSharp.fluid} alt="Calendar" className="project-image" />
                ...
                <div className="section__column">
                  <div className="project-link">
                    <Img fluid={this.props.data.pomodoro.childImageSharp.fluid} alt="devbees" className="project-image" />
              ...
              <div className="section__fs-container">
                <div className="section__fs-inner">
                  <h2 className="section__fs-title">
                    Visit my GitHub&nbsp;&nbsp;&nbsp;
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" className="section__fs-title-icon">

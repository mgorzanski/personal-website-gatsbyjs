              ...
              <div className="section__fs-container">
                <div className="section__fs-inner">
                  ...
                  <p className="section__fs-text">
                    ...
                    React/React Native developer, JavaScript developer or
                    similar. If you think I'm the right candidate let me know.{' '}
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <br />
                      Ability to use package managers such as NPM and Yarn as
                      well as task manager Webpack
                      <br />
                      JavaScript
                      <br />
                  ...
                  <tr>
                    ...
                    <td>
                      <span>
                        High School, Centrum Kształcenia Zawodowego i
                        Ustawicznego nr 2, Wadowice, 2016 - 2020
                      </span>
                      <br />
                      IT technician
                    </td>
          ...
          <section className="section" id="work">
            <div className="section__inner">
              ...
              <p className="section__text">
                Here you can see some of my projects. There are more on my
                GitHub.
              </p>
              <div className="section__columns">
                ...
                <div className="section__column">
                  <div className="project-link">
                    ...
                    <div className="project-links">
                      <p>
                        Built using Laravel 5. Currently I cannot provide a link
                        to the working app.
                      </p>
                      <a
                        className="project-link-btn"
              ...
              <div className="section__columns">
                <div className="section__column">
                  <div className="project-link">
                    ...
                    <div className="project-links">
                      <p>
                        My old personal website, builded using GatsbyJS, hosted
                        on Netlify.
                      </p>
                      <a
                        className="project-link-btn"
